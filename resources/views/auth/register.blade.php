                ...
                <div class="col-12 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      ...
                      <form class="row g-3 needs-validation" novalidate action="{{ route('register_store') }}" method="POST">
                        @csrf
                        <div class="col-12">
                        ...
                        <div class="col-12">
                          ...
                          <input type="text" name="gender" class="form-control" id="yourName" required>
